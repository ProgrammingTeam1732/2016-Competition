...
// I had to make a copy because I wanted to add my own code but all the variables are private
...
public class MyUSBCamera {
  ...
  public MyUSBCamera(String name) {
    m_name = name;
    openCamera();
  }
  ...
  public synchronized int getBrightness() {
    return (int) NIVision.IMAQdxGetAttributeI64(m_id, ATTR_BR_VALUE);
  }
  ...
  public synchronized int getWhiteBalance() {
	    return (int) NIVision.IMAQdxGetAttributeI64(m_id, ATTR_WB_VALUE);
  }
  ...
  public synchronized int getExposure() {
	    return (int) NIVision.IMAQdxGetAttributeI64(m_id, ATTR_EX_VALUE);
  }
